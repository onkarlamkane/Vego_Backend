...
//    public ResponseEntity<UserDocumentDTO> updateVerificationStatus(
...
//
//        return ResponseEntity.ok(service.updateVerificationStatus(userId, adhaarFrontStatus, adhaarBackStatus, licenseStatus));
//    }
//}
